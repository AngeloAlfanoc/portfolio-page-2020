        ...
        return ( <> <Header/> < div className = "bg-white" > <div className="container">
            <div
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            refers to methods, Genk, Limburg.</p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            ...
                            <a rel="noopener noreferrer external nofollow noopener" href="https://www.termsfeed.com/terms-conditions-generator/" target="_blank">Terms and Conditions Generator</a>.</p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            ...
                            refers to methods, accessible from
                            <a href="www.methods.digital" rel="external nofollow noopener" target="_blank">www.methods.digital</a>
                        </p>
                    </li>
                    <li>
                        <p>
                ...
                <p>Your access to and use of the Service is conditioned on Your acceptance of
                    and compliance with these Terms and Conditions. These Terms and Conditions apply
                ...
                <p>These Terms and Conditions may have been translated if We have made them
                    ...
                    prevail in the case of a dispute.</p>
                ...
                <ul>
                    <li>
                        <p>By email: info@methods.me</p>
                    </li>
                    <li>
                        <p>By visiting this page on our website:
                            <a rel="noopener noreferrer external nofollow noopener"
                                href="https://www.methods.digital/contact"
                                target="_blank">methods.digital/contact</a>
                        </p>
                    </li>
                </ul>
            </div>
